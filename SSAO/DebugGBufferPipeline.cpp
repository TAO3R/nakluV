...
#include "../spv/SSAO/debug_gbuffer.frag.inl"
;

void Tutorial::DebugGBufferPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass,
...
void Tutorial::DebugGBufferPipeline::destroy(RTG &rtg) {
