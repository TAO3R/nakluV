...
#include "../spv/SSAO/fullscreen.vert.inl"
;

static uint32_t frag_code[] =
#include "../spv/SSAO/deferred_lighting.frag.inl"
;

void Tutorial::DeferredLightingPipeline::create(
	RTG &rtg, VkRenderPass render_pass, uint32_t subpass,
	VkDescriptorSetLayout set0_GBuffer_,
	...
	VkDescriptorSetLayout set6_PBREnv)
{
...

	{
		std::array<VkDescriptorSetLayout, 7> layouts{
			set0_GBuffer_, set1_World, set2_Lights, set3_Shadows,
			set4_Cubemap, set5_LambertianCubemap, set6_PBREnv,
		};
...
void Tutorial::DeferredLightingPipeline::destroy(RTG &rtg) {
