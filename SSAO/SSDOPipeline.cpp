...
#include "../spv/SSAO/ssdo.frag.inl"
;

void Tutorial::SSDOPipeline::create(
	...
	VkDescriptorSetLayout set4_LambertianCubemap)
{
...

	{
		std::array<VkDescriptorSetLayout, 5> layouts{
			set0_GBuffer, set1_SSAOParams, set2_Noise,
			set3_World, set4_LambertianCubemap,
		};
...
void Tutorial::SSDOPipeline::destroy(RTG &rtg) {
